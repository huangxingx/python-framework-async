...
from constant.permission import PAGE_CHANNEL_URL_PATTERN, DEFAULT_PERMISSION, OPERATE_PERMISSION_CODE_MAP
from handler.auth import AuthBaseHandler
from handler.base import BaseRequestHandler
from yxexceptions.common import *
...
class BaseAdminHandler(BaseRequestHandler):
    ...
    def check_page_permission(self):
        ...
        if self.useradmin:
            is_super = self.useradmin.get('is_super')
            if is_super:
                return True
